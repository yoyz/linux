...
std::mutex mtx_iio;       // protect constructor of mtx_iio
//std::mutex mtx_iio2;      // protect Iio ( moveTrash, getFd, getTrashFd,existFd )
std::recursive_mutex mtx_iio2;      // protect Iio ( moveTrash, getFd, getTrashFd,existFd )
                          // and add_write/read_count, add_write/read_time
                          // fprintf,fwrite, fread,write,read,pwrite,writev,fopen,openat,
                          // openat64,open,open64,creat,closedir,close,fclose,dup,dup2,dup3,

//std::mutex mtx;           // protect on write/read/fwrite/fread and similar
std::recursive_mutex mtx;
std::mutex mtx_logger;    // protect Logger::add
std::mutex mtx_bwgplot;   // protect BWGnuplot::add
