...
private: 
  ...
  std::map<std::string,int64_t> total_write_size;
  std::map<std::string,int64_t> total_read_size;

  std::map<std::string,int64_t> total_write_count;
  std::map<std::string,int64_t> total_read_count;
